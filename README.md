...
|--|--|--|--|--|
| [Bank](https://github.com/CharlyMannion/bank-tech-test) | My solution to the Bank Tech test | 3 days | Ruby | Rspec, Rubocop |[Airport](https://github.com/CharlyMannion/airport_solo) | A programme that allows an Air Traffic Controller to manage the take off and landing of planes at multiple airports. This system is written, in Ruby. This is a recent project, completed in my journey to get back in to coding | 2 days | Ruby | Rspec, Rubocop | 
